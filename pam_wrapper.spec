...
Version  : 1.1.4
Release  : 1
URL      : https://ftp.samba.org/pub/cwrap/pam_wrapper-1.1.4.tar.gz
Source0  : https://ftp.samba.org/pub/cwrap/pam_wrapper-1.1.4.tar.gz
Source1  : https://ftp.samba.org/pub/cwrap/pam_wrapper-1.1.4.tar.gz.asc
...
%prep
%setup -q -n pam_wrapper-1.1.4
cd %{_builddir}/pam_wrapper-1.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687446518
mkdir -p clr-build
pushd clr-build
